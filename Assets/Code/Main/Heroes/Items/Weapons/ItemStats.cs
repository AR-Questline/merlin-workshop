    ...
    public partial class ItemStats : Element<Item> {
        ...
        public partial struct ItemStatsWrapper {
            ...
            public void PrepareForSave(ItemStats itemStats) {
                ...
                LightAttackCostDif = itemStats.LightAttackCost.ValueForSave - dataSource.lightAttackStaminaCost;
                HeavyAttackCostDif = itemStats.HeavyAttackCost.ValueForSave - dataSource.heavyAttackStaminaCost;
                HeavyAttackHoldCostPerTickDif = itemStats.HeavyAttackHoldCostPerTick.ValueForSave - dataSource.heavyAttackHoldCostPerTick;
                DrawBowCostPerTickDif = itemStats.DrawBowCostPerTick.ValueForSave - dataSource.drawBowStaminaCostPerTick;
                HoldItemCostPerTickDif = itemStats.HoldItemCostPerTick.ValueForSave - dataSource.holdItemStaminaCostPerTick;
                PushStaminaCostDif = itemStats.PushStaminaCost.ValueForSave - dataSource.pushStaminaCost;
                BlockStaminaCostMultiplierDif = itemStats.BlockStaminaCostMultiplier.ValueForSave - dataSource.blockStaminaCostMultiplier;
                ParryStaminaCostDif = itemStats.ParryStaminaCost.ValueForSave - dataSource.parryStaminaCost;
                
                BaseMinDmgDif = itemStats.BaseMinDmg.ValueForSave - dataSource.minDamage - itemStats._appliedDamageGain;
                BaseMaxDmgDif = itemStats.BaseMaxDmg.ValueForSave - dataSource.maxDamage - itemStats._appliedDamageGain;
                DamageGainDif = itemStats.DamageGain.ValueForSave - dataSource.damageGain;
                HeavyAttackDamageMultiplierDif = itemStats.HeavyAttackDamageMultiplier.ValueForSave - dataSource.heavyAttackDamageMultiplier;
                PushDamageMultiplierDif = itemStats.PushDamageMultiplier.ValueForSave - dataSource.pushDamageMultiplier;
                BackStabDamageMultiplierDif = itemStats.BackStabDamageMultiplier.ValueForSave - dataSource.backStabDamageMultiplier;
                ArmorPenetrationDif = itemStats.ArmorPenetration.ValueForSave - dataSource.armorPenetration;
                DamageIncreasePerChargeDif = itemStats.DamageIncreasePerCharge.ValueForSave - dataSource.damageIncreasePerCharge;
                ArmorDif = itemStats.Armor.ValueForSave - dataSource.armor - itemStats._appliedArmorGain;
                ArmorGainDif = itemStats.ArmorGain.ValueForSave - dataSource.armorGain;
                BlockAngleDif = itemStats.BlockAngle.ValueForSave - dataSource.blockAngle;
                BlockDif = itemStats.Block.ValueForSave - dataSource.blockDamageReductionPercent - itemStats._appliedBlockGain;
                BlockGainDif = itemStats.BlockGain.ValueForSave - dataSource.blockGain;
                ForceDif = itemStats.ForceDamage.ValueForSave - dataSource.forceDamage - itemStats._appliedForceGain;
                ForceGainDif = itemStats.ForceDamageGain.ValueForSave - dataSource.forceDamageGain;
                ForceDamagePushMultiplierDif = itemStats.ForceDamagePushMultiplier.ValueForSave - dataSource.forceDamagePushMultiplier;
                RagdollForceDif = itemStats.RagdollForce.ValueForSave - dataSource.ragdollForce;
                PoiseDamageDif = itemStats.PoiseDamage.ValueForSave - dataSource.poiseDamage - itemStats._appliedPoiseDamageGain;
                PoiseDamageGainDif = itemStats.PoiseDamageGain.ValueForSave - dataSource.poiseDamageGain;
                PoiseDamageHeavyAttackMultiplierDif = itemStats.PoiseDamageHeavyAttackMultiplier.ValueForSave - dataSource.poiseDamageHeavyAttackMultiplier;
                PoiseDamagePushMultiplierDif = itemStats.PoiseDamagePushMultiplier.ValueForSave - dataSource.poiseDamagePushMultiplier;
                WeightDif = itemStats.Weight.ValueForSave - dataSource.Weight + itemStats._appliedWeightLoss;
                ...
                WeakSpotDamageMultiplierDif = itemStats.WeakSpotDamageMultiplier.ValueForSave - dataSource.weakSpotDamageMultiplier;
                SneakDamageMultiplierDif = itemStats.SneakDamageMultiplier.ValueForSave - dataSource.sneakDamageMultiplier;
            }
        }
    }
}