...
namespace Awaken.TG.Main.Heroes.Combat {
    public partial class DealDamageInConeOverTime : DealDamageInAreaOverTimeBase {
        ...
        protected readonly ConeDamageParameters _coneDamageParameters;
        ...
        protected override void DealDamageInstant() {
            DamageUtils.DealDamageInConeInstantaneous(Attacker, _coneDamageParameters, _origin);
        }
        ...
        protected override void DealDamageOverTime(float percentage) {
            ...
            DamageUtils.DealDamageInConeOverTime(Attacker, _coneDamageParameters, _origin, radius, in _damageDealtTo);
        }
    }
}