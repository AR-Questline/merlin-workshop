...
namespace Awaken.TG.Main.Utility.UI.Feedbacks {
    public class VCHighlightFeedback : VCFeedback {
        const string GroupName = "Setup";
        
        [SerializeField, BoxGroup(GroupName)] Image image;
        [SerializeField, BoxGroup(GroupName)] float startAlpha;
        [SerializeField, BoxGroup(GroupName)] float startDelay;
        [SerializeField, BoxGroup(GroupName)] FeedbackStep[] feedbackSteps = Array.Empty<FeedbackStep>();
