...
namespace Awaken.TG.Main.Utility.Video.Subtitles {
  // source: https://github.com/roguecode/Unity-Simple-SRT
  public class SRTParser
  {
    ...
    static public List<SubtitleBlock> Load(TextAsset textAsset)
    {
      if (textAsset == null)
      {
        Log.Important?.Error("Subtitle file is null");
        return null;
      }

      var lines = textAsset.text.Split(new[] { "\r\n", "\r", "\n" }, StringSplitOptions.None);

      var currentState = eReadState.Time;
  ...
  public class SubtitleBlock
  {
    ...
    public int Index { [UnityEngine.Scripting.Preserve] get; private set; }
    public double Length { [UnityEngine.Scripting.Preserve] get; private set; }
