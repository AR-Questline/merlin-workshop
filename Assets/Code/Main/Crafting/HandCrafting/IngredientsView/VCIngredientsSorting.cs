...
namespace Awaken.TG.Main.Crafting.HandCrafting.IngredientsView {
    public class VCIngredientsSorting : ViewComponent<IngredientTabContents>, IPromptHost {
        [SerializeField] VGenericPromptUI sortPrompt;
        public Transform PromptsHost => transform;
        
        readonly IngredientsSorting[] _allowedComparers = {
            IngredientsSorting.AlphabeticallyAscending,
            IngredientsSorting.AlphabeticallyDescending,
            IngredientsSorting.ByPriceAscending,
            IngredientsSorting.ByPriceDescending,
        };

        IngredientsSorting[] _comparers;
        Prompt _sortPrompt;
        ...
        protected override void OnAttach() {
            ...
            _currentComparer = _comparers.IndexOf(Target.IngredientsGridUI.CurrentSorting);
        ...
        async UniTaskVoid Refresh() {
            ...
            Target.IngredientsGridUI.ChangeItemsComparer(comparer);
        }
