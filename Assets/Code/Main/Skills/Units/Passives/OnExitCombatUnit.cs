...
namespace Awaken.TG.Main.Skills.Units.Passives {
    ...
    public class OnExitCombatUnit : PassiveListenerWithPayloadUnit<ICharacter, ICharacter> {
        ...
        protected override Event<ICharacter, ICharacter> Event(Skill skill, Flow flow) => ICharacter.Events.CombatExited;
    }
}