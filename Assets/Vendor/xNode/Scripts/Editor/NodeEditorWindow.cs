...
namespace XNodeEditor {
    ...
    public partial class NodeEditorWindow : EditorWindow {
        public static bool FarView => current.zoom > 2.5f;
        ...
        [System.Serializable] private class NodePortReference {
            ...
            [SerializeField] private NodePort.FieldNameCompressed _name;

            public NodePortReference(XNode.NodePort nodePort) {
                _node = nodePort.node;
                _name = nodePort.fieldNameCompressed;
            }
        ...
        public static bool OnOpen(int instanceID, int line) {
            ...
            XNode.Node node = EditorUtility.InstanceIDToObject(instanceID) as XNode.Node;
            if (node != null && node.graph != null) {
                Open(node.graph).CenterOnNode(node);
        ...
        public static NodeEditorWindow Open(XNode.NodeGraph graph) {
            ...
            if (NodeEditorAssetModProcessor.ValidateNodes(graph)) {
