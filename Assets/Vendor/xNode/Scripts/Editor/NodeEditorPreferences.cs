...
namespace XNodeEditor {
    ...
    public static class NodeEditorPreferences {
        ...
        public class Settings : ISerializationCallbackReceiver {
            ...
            public float noodleDensity = 0.1f;
        ...
        private static void NodeSettingsGUI(string key, Settings settings) {
            ...
            settings.noodleDensity = EditorGUILayout.Slider(new GUIContent("Noodle Density", "Impacts performance, 1 is default by author"), settings.noodleDensity, 0f, 1f);
