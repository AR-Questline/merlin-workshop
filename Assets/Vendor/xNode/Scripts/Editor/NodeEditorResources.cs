...
namespace XNodeEditor {
    public static class NodeEditorResources {
        ...
        public static Texture2D pentagon { get { return _pentagon != null ? _pentagon : _pentagon = Resources.Load<Texture2D>("xnode_pentagon"); } }
        private static Texture2D _pentagon;
        public static Texture2D pentagonOuter { get { return _pentagonOuter != null ? _pentagonOuter : _pentagonOuter = Resources.Load<Texture2D>("xnode_pentagon_outer"); } }
        private static Texture2D _pentagonOuter;

        // Styles
        public static Styles styles { get { return _styles != null ? _styles : _styles = new Styles(); } }
        public static Styles _styles = null;
        public static GUIStyle OutputPort { get { return new GUIStyle(EditorStyles.label) { alignment = TextAnchor.UpperRight, richText = true}; } }
        public class Styles {
            public GUIStyle inputPort, inputPortLabel, outputPort, nodeHeader, nodeBody, tooltip, nodeHighlight;
            ...
            public Styles() {
                ...
                inputPortLabel = new GUIStyle(EditorStyles.label);
                inputPortLabel.richText = true;
                inputPortLabel.alignment = TextAnchor.UpperLeft;
            }
        }
