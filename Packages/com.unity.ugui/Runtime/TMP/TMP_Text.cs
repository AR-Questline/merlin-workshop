    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        */
        ...
        internal TextElement GetTextElement(uint unicode, FontAsset fontAsset, FontStyles fontStyle, FontWeight fontWeight, out bool isUsingAlternativeTypeface)
        {
            ...
            UnityEngine.TextCore.Text.FontStyles textCoreFontStyle = (UnityEngine.TextCore.Text.FontStyles)((int)fontStyle);
            TextFontWeight textCoreFontWeight = (TextFontWeight)((int)fontWeight);
            ...
            {
                // Add character to font asset lookup cache
                fontAsset.AddCharacterToLookupCache(unicode, character, textCoreFontStyle, textCoreFontWeight);
                return character;
            }
            ...
            if (fontStyle != FontStyles.Normal || fontWeight != FontWeight.Regular)
            {
                ...
                {
                    // Add character to font asset lookup cache
                    fontAsset.AddCharacterToLookupCache(unicode, character, UnityEngine.TextCore.Text.FontStyles.Normal, TextFontWeight.Regular);
                    return character;
                }
            ...
            else
            {
                ...
                switch ((MarkupTag)m_xmlAttribute[0].nameHashCode)
                {
                    ...
                    case MarkupTag.ITALIC:
                        ...
                        // Force italics to rely only on the typeface's italic style; disables synthetic italics  
                        m_ItalicAngle = 0; // prev: m_currentFontAsset.italicStyleSlant;
