...
// Check if character is already cached using the composite unicode value the takes into consideration the font style and weight
        ...
        static Character SearchFallbacksForCharacter(uint unicode, FontAsset sourceFontAsset, FontStyles fontStyle, FontWeight fontWeight, out bool isAlternativeTypeface)
        {
            isAlternativeTypeface = false;
