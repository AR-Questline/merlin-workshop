...
namespace Pathfinding {
    ...
    public readonly struct NNInfo
    {
        ...
        public NNInfo(GraphNode node, Vector3 position, float distanceCostSqr) : this()
        {
        }
    ...
    public readonly struct Progress
    {
        ...
        public Progress(float progress, ScanningStage stage, int graphIndex = 0, int graphCount = 0) : this()
        {
        }
    ...
    public struct IntRect
    {
        ...
        public IntRect(int xmin, int ymin, int xmax, int ymax) : this()
        {
        }
    ...
    public struct GraphMask
    {
        ...
        public GraphMask(int value) : this()
        {
        }
