...
namespace Pathfinding {
	...
	public struct Connection {
		...
		public Connection (GraphNode node, uint cost, bool isOutgoing, bool isIncoming) : this()
        {
        }
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public Connection(GraphNode node, uint cost, byte shapeEdgeInfo) : this()
        {
        }
	...
	public abstract class GraphNode {
        ...
        public void GetConnections (System.Action<GraphNode> action, int connectionFilter = Connection.OutgoingConnection) {
        }
