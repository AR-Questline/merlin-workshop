...
{
    /// <summary>
    /// It's a copy of EventMachine but without Update / FixedUpdate / LateUpdate methods.
    /// </summary>
    public abstract class EventMachineUpdateless<TGraph, TMacro> : Machine<TGraph, TMacro>, IEventMachine
