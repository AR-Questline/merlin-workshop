...
#if UNITY_EDITOR
            UnityEditor.AssemblyReloadEvents.beforeAssemblyReload += CullingGroupManager.instance.Cleanup;
            UnityEditor.EditorApplication.quitting += CullingGroupManager.instance.Cleanup;
#else
            Application.quitting += CullingGroupManager.instance.Cleanup;
#endif
