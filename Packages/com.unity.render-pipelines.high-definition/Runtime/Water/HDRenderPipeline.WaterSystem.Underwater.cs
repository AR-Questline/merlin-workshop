    ...
    partial class WaterSystem
    {
        ...
        void EvaluateUnderWaterSurface(HDCamera hdCamera)
        {
            ...
            for (int surfaceIdx = 0; surfaceIdx < numWaterSurfaces; ++surfaceIdx)
            {
                ...
                {
                    // We override the default behaviour of checking bounds to our system.
                    // in our case checking volume priority does not make sense
                    if (WaterSurface.currentWater == currentWater)
                    {
