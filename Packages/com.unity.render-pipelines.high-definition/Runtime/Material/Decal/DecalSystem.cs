    ...
    partial class DecalSystem
    {
        ...
        public DecalHandle AddDecal(DecalProjector decalProjector)
        {
            ...
            if (material)
            {
                ...
                {
                    Debug.LogError($"Decal material {material.name} is not instancing compatible. Decal rendering will be skipped.", material);
                    material = null;
                }
            }
