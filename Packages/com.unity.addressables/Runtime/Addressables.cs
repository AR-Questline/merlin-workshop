...
namespace UnityEngine.AddressableAssets
{
    ...
    public static class Addressables
    {
        ...
        public static void AddModLocator(IResourceLocator locator) {
            m_Addressables.AddModLocators(locator);
        }

        public static void RemoveModLocators() {
            m_Addressables.RemoveModLocators();
        }
