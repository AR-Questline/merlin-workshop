...
namespace UnityEngine.AddressableAssets
{
    internal class AddressablesImpl : IEqualityComparer<IResourceLocation>
    {
        ...
        public void AddModLocators(IResourceLocator locator) {
            m_ResourceLocators.Insert(m_ModLocators++, new ResourceLocatorInfo(locator, null, null));
        }

        public void RemoveModLocators() {
            m_ResourceLocators.RemoveRange(0, m_ModLocators);
            m_ModLocators = 0;
        }
